...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="COUNTER" URI="http://resources/4.1.10/app/COUNTER/0" description="Counts the occurrences of external events using one timer slice of CCU4 or CCU8 " mode="NOTSHARABLE" version="4.1.10" minDaveVersion="4.3.2" instanceLabel="COUNTER_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_edge_detection" URI="http://resources/4.1.10/app/COUNTER/0/vs_counter_ccu4_edge_event" hwSignal="e0as" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_edge_detection" URI="http://resources/4.1.10/app/COUNTER/0/vs_counter_ccu8_edge_event" hwSignal="e0as" hwResource="//@hwResources.1" required="false" visible="true"/>
  ...
  <connections URI="http://resources/4.1.10/app/COUNTER/0/http://resources/4.1.10/app/COUNTER/0/vs_counter_ccu4_edge_event/http://resources/4.0.8/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_edge_detection" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.8">
